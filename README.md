The two test files are under `src/test/java`
...
- `CarbCalculatorTests` -> Contains three tests:
  ...
  - test02_MetricUnitsHappyPath -> Checks for Matric units happy path
  - test03_KatchMcArdleFormula -> Checks for KatchcArdle calculation
